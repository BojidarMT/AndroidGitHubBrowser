 ...
 */
public class FetchOwnedRepositoriesTask extends AsyncTask<Long, Void, List<Repository>> {
    ...
    public FetchOwnedRepositoriesTask(Context context, String processMessage) {
    ...
    protected List<Repository> doInBackground(Long... params) {
        return SQLitePersistUtil.fetchOwnedRepositories(this.context, params[0]);
    }
